...
<section id="js-checkout-summary" class="js-cart ax-cart-summary cart-summary" data-refresh-url="{$urls.pages.cart}?ajax=1&action=refresh">
  ...
  <div class="checkout cart-btn-actions">
      <div class="text-sm-center">
        <a href="{Context::getContext()->link->getPageLink('cart', null, Context::getContext()->language->id, ['action' => 'show'], false, null, true)}" class="btn btn-primary">{l s='View And Edit Cart' d='Shop.Theme.Axon'}</a>
      </div>
  </div>
