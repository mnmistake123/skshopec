...
{block name='step_content'}
      ...
      {foreach from=$module_options item="option"}
        <div>
          <div id="{$option.id}-container" class="payment-option clearfix">
            ...
            <form method="GET" class="ps-hidden-by-js hidden">
  ...
  {if $conditions_to_approve|count}
    <p class="ps-hidden-by-js hidden">
    ...
    <form id="conditions-to-approve" class="js-conditions-to-approve" method="GET">
      <ul>
        {foreach from=$conditions_to_approve item="condition" key="condition_name"}
          <li>
				<label class="js-terms wrapper-custom-checkbox">	
					...
					<span class="text">{$condition nofilter}</span>
				</label>
          </li>
        {/foreach}
      </ul>
  ...
  <div id="payment-confirmation" class="js-payment-confirmation">
    ...
    <div class="ps-hidden-by-js hidden">
