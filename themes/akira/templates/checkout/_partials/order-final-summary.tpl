  ...
  <div class="row">
    <div class="col-md-12">
      ...
      {l s='Addresses' d='Shop.Theme.Checkout'}
        <span class="step-edit step-to-addresses js-edit-addresses"><i class="lar la-edit edit"></i> {l s='edit' d='Shop.Theme.Actions'}</span>
      </h4>
    </div>
  </div>
  <div class="row">
  ...
  {if !$cart.is_virtual}  
    <div class="row">
        ...
        {l s='Shipping Method' d='Shop.Theme.Checkout'}
            <span class="step-edit step-to-delivery js-edit-delivery"><i class="lar la-edit edit"></i> {l s='edit' d='Shop.Theme.Actions'}</span>
        </h4>
