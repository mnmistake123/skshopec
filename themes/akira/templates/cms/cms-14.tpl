...
<div class="sk-landing">
  ...
  <section class="sk-hero">
    ...
    <div class="sk-hero-content sk-container">
      ...
      <a href="{$link->getProductLink(1100)}" class="sk-btn sk-btn-lg">
  ...
  <section class="sk-section sk-section-white">
    <div class="sk-container">
      ...
      <div style="text-align:center; margin-top: 48px;">
        <a href="{$link->getProductLink(1100)}" class="sk-btn sk-btn-lg">Quiero acceder al curso</a>
      </div>
    </div>
  </section>
  ...
  <section class="sk-section sk-section-soft">
    <div class="sk-container">
      <div class="sk-instructor-col">
        <div>
          {* Replace with Saruka's real photo uploaded to /img/cms/ *}
          <img
  ...
  <section class="sk-section sk-section-soft">
    <div class="sk-container">
      ...
      <div class="sk-price-box">
        ...
        <p class="sk-price-tag"><sup>$</sup>76<span style="font-size: 22px;"> USD</span></p>
        <p class="sk-price-label">Pago único · Acceso inmediato</p>
        <div style="margin: 32px 0;">
          <a href="{$link->getProductLink(1100)}" class="sk-btn sk-btn-lg" style="width: 100%; display: block; text-align: center;">
  ...
  <section class="sk-closing">
    ...
    <div class="sk-closing-content sk-container">
      ...
      <p style="margin-top: 20px; font-size: 13px; color: rgba(255,255,255,0.35);">$76 USD · Pago único · Acceso inmediato</p>
    </div>
  </section>
