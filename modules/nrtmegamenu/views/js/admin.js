jQuery(function($){
    ...
    $('#manufacturers').autocomplete('index.php?controller=AdminModules&configure=nrtmegamenu&act=gsmm&ajax=1&token='+token, {
        minChars: 1,
        autoFill: true,
        max:200,
        matchContains: true,
		...
		$('#curr_manufacturers').append('<li>'+name+'<a href="javascript:void(0)" class="del_manufacturer"><img src="../img/admin/delete.gif" /></a><input type="hidden" name="id_manufacturer[]" value="'+id+'" /></li>');
